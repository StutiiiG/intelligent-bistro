// Local mirror of the backend menu so the UI can render without a roundtrip.
// Kept in sync manually with backend/src/menu.js.
...
export const MENU = [
  ...
  },
  {
    ...
    tags: ["coffee", "drink", "iced", "vegetarian"],
  },
  {
    id: "sparkling-water",
    ...
    tags: ["water", "drink", "vegetarian", "vegan"],
  },
  {
    id: "chocolate-tart",
...
// Curated dietary / vibe filters — each chip maps to a predicate over an item's tags.
